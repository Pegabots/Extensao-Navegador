...
Olá! Obrigado pelo interesse em contribuir com essa Extensão. Esse repositório implementa a Extensão do Pegabot para navegador, capaz de buscar fazer uma análise de um perfil chamando a API do Pegabot.
...
A Extensão para navegador do Pegabot aceita contribuições que:
* Proponha um desenho para a extensão
* Implemente uma extensão simples para navegadores
